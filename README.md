...
Visualize Landsat true-color and false-color composites.
Compute NDVI for June and September.
Quantify seasonal vegetation change using ΔNDVI.
Compute NDWI and identify open-water pixels.
Convert Landsat `ST_B10` digital numbers to land surface temperature.
Compare LST between low- and high-NDVI surfaces.
Examine the NDVI–LST relationship.
Generate publication-style summary figures for seasonal interpretation.
---
Data Processing
